...
* *The impact of the thresholds of 10, 20 and 50 employees on the size of French companies*
* *Le Polimètre (France, 2007)* : analysing political behavior using quiz data
* Estimating incumbency advantage in French elections
...
## Why is it so nice to work at Etalab 1/2 ?
...
## Why is it so nice to work at Etalab 2/2 ?
...
## What do we do at Etalab ? (long version)

* Developping products
* Writing bills 
* Writing reports on data governance/data policy
* HData science and artificial intelligence for the public sector
...
## Writing bills { .fullpage }

<center>
<img src="/home/paul-antoine/projets/pachevalier.github.io/slides/images/loipourunerepubliquenumerique.png">
</center>

## Open data by default and data as a public service
...
* Legal recognition to « reference data » (Digital Republic Act, 2016) 
* 9 key datasets that are critical for the society and economy, including : Company Register (Sirene), Land Register (Cadastre), National adresses database, National directory of associations, etc.
...
<img src="images/couv-rapport-agd-20162017.png" class="one-col-image">
</p>
</div>
...
* 1/4 hiring is consecutive to a job offer
* A small algorithm predicting the number of hirings would help applying in the good company.
* Basically, we use past hiring as a predictor for future hirings 
* Job seeker can easily get a list of companies where the have a probability to get hired.
...
* We select the best challenges
* We find the best people (developers/data scientists/designers) to take on the challenge
* They have 10 months to get results !
* It works for 3 reasons : deadlines, ownership, fellowship.

## And now AI

<div class="double">
<p class="double-flow">
* 2018 : Call for proposals to select AI challenges in governmental agencies
* 2019 : AI lab to help governmental agencies
</p>
<p class="double-flow">
<img src="images/villani.png">
</p>
</div>

## Inspiring figures in the field of data science

* Mike Flowers for apply work at NYC
* Hadley Wickham for developing the tidyverse
